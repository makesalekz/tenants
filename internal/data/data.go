...
var ProviderSet = wire.NewSet(NewData, config.NewConfig, jwt.NewJwtProcessor, NewNatsClient, NewDialer, NewTenantsRepo, NewMembersRepo, NewInvitesRepo, NewIamRemote)
