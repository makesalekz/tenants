...
func (UnimplementedMembersServer) CreateMembers(context.Context, *CreateMembersRequest) (*v1.EmptyReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateMembers not implemented")
}
...
func (UnimplementedMembersServer) GetShortMembers(context.Context, *IdentitiesRequest) (*MembersReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetShortMembers not implemented")
}
func (UnimplementedMembersServer) GetMemberIdentities(context.Context, *GetMemberIdentitiesRequest) (*GetMemberIdentitiesReply, error) {
	return nil, status.Error(codes.Unimplemented, "method GetMemberIdentities not implemented")
}
...
func (UnimplementedMembersServer) CountMembers(context.Context, *v1.EmptyRequest) (*CountMembersReply, error) {
	return nil, status.Error(codes.Unimplemented, "method CountMembers not implemented")
}
